...
public class Ports {
    ...
    public static int DRIVE_SOL_FRONT_LEFT = 1;
    public static int DRIVE_SOL_BACK_LEFT = 2;
    public static int DRIVE_SOL_FRONT_RIGHT = 3;
    public static int DRIVE_SOL_BACK_RIGHT = 4;
